...
export function HostClusterForm({ initial, onSaved, onCancel }) {
    ...
    return (_jsxs("form", { onSubmit: save, className: "card", style: { marginBottom: 16 }, children: [_jsx("h4", { style: { marginTop: 0 }, children: editing ? `Edit host cluster "${initial.name}"` : "Add host cluster" }), error && _jsx("div", { className: "error", children: error }), _jsxs("div", { style: {
                    ...
                    gap: 12,
                            ...
                            fontSize: 12,
                        }, required: !editing }), _jsxs("div", { className: "form-actions", style: { marginTop: 8 }, children: [_jsx("button", { type: "button", onClick: runTest, disabled: !kubeconfigChanged || testing, children: testing ? "Testing…" : "Test connection" }), testResult && _jsx(TestResultPill, { result: testResult })] }), testResult && !testResult.success && (_jsxs("div", { className: "error", style: { marginTop: 8, whiteSpace: "pre-wrap" }, children: [_jsx("strong", { children: "Connection failed." }), " ", testResult.error ?? "no error detail returned", _jsxs("div", { className: "muted", style: { fontSize: 12, marginTop: 6 }, children: ["Common causes when Foyre runs inside Kubernetes: the kubeconfig's ", _jsx("code", { children: "server:" }), " URL points at", _jsx("code", { children: " 127.0.0.1" }), " / ", _jsx("code", { children: "localhost" }), " (unreachable from inside the pod), or the API server's TLS certificate doesn't include a name reachable from the pod. Set", _jsx("code", { children: " server:" }), " to a node IP / DNS name that the Foyre pod can reach."] })] }))] }), testResult?.success && (_jsxs("dl", { className: "muted", style: {
                    display: "grid",
